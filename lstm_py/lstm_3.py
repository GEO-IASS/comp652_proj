...
class Config(object):
    ...
    def __init__(self, X_train, X_test):
        ...
        self.n_steps = 9  # 128 time_steps per series
        ...
        self.n_hidden = 15  # nb of neurons inside the neural network
...
if __name__ == "__main__":
    ...
    X_train_signals_paths = [
        DATASET_PATH + TRAIN + "X_train.txt" for signal in INPUT_SIGNAL_TYPES
    ]
    X_test_signals_paths = [
        DATASET_PATH + TEST + "X_test.txt" for signal in INPUT_SIGNAL_TYPES
    ]
